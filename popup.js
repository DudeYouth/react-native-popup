...
export default class Popup extends Component {
    ...
    <TouchableOpacity style={styles.popupButton}><Text style={[commonStyle.title,{textAlign:"center",color:"#fff"}]} onPress={this.onSubmit.bind(this)}>{this.props.buttonText||"确定"}</Text></TouchableOpacity>
                </Animated.View>
